...
let bd = new Array(4);
bd[0] =['PERA','BANANA','MELON','SANDIA','MANGO','KIWI'];
bd[1] =['PIANO','GUITARRA','FLAUTA','BAJO','TROMPETA','SAXOFON','BATERIA'];
bd[2] =['LEON','GALLINA','PERRO','LEOPARDO','TORTUGA','MONO','ELEFANTE'];
bd[3] =['CUBA','BRASIL','COLOMBIA','VENEZUELA','ECUADOR','MEXICO','PERU'];
